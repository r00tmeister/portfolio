<template>
  ...
  <div class="md:hidden " :class="burgerMenu ? 'bg-black bg-transparent bg-opacity-20 backdrop:filter backdrop-blur-md shadow-lg h-screen w-full z-[11]' : ''">
    <ul class="flex flex-col justify-center content-center items-center font-mono">
